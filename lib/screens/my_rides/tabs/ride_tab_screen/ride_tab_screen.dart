...
class RideTabScreen extends StatefulWidget {
  const RideTabScreen({Key? key}) : super(key: key);

  @override
  State<RideTabScreen> createState() => _RideTabScreenState();
}

class _RideTabScreenState extends State<RideTabScreen> {
  @override
